        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Hotel_AverageRating", "\"AverageRating\" BETWEEN 0 AND 5");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdultPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ChildPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Room_Prices", "\"AdultPrice\" >= 0 AND \"ChildPrice\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelImages_SingleCoverPerHotel",
                table: "HotelImages",
                column: "HotelId",
                unique: true,
                filter: "\"IsCover\" = true AND \"Deleted\" = false");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_HotelId_ProcessedAt",
                table: "Payments",
                columns: new[] { "HotelId", "ProcessedAt" });
